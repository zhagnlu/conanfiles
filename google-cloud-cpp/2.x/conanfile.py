...
class GoogleCloudCppConan(ConanFile):
    ...
    def configure_cmake(self, cmake):
        definitions = []
        definitions.append("-DBUILD_TESTING=OFF")
        definitions.append("-DGOOGLE_CLOUD_CPP_ENABLE_MACOS_OPENSSL_CHECK=OFF")
        definitions.append("-DGOOGLE_CLOUD_CPP_ENABLE_BIGTABLE=OFF")
        definitions.append("-DGOOGLE_CLOUD_CPP_ENABLE_BIGQUERY=OFF")
        definitions.append("-DGOOGLE_CLOUD_CPP_ENABLE_SPANNER=OFF")
        definitions.append("-DGOOGLE_CLOUD_CPP_ENABLE_STORAGE=ON")
        definitions.append("-DGOOGLE_CLOUD_CPP_ENABLE_PUBSUB=OFF")
        definitions.append("-DGOOGLE_CLOUD_CPP_ENABLE_IAM=ON")
        definitions.append("-DGOOGLE_CLOUD_CPP_ENABLE_LOGGING=ON")
        cmake.configure(cli_args=definitions)
    ...
    _GA_COMPONENTS_BASE = {"iam", "storage"}
